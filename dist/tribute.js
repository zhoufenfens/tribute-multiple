  ...
  var TributeEvents = /*#__PURE__*/function () {
    ...
    return _createClass(TributeEvents, [{
      ...
      value: function click(instance, event) {
        ...
        var isBtn = event.target.getAttribute('data-tribute-btn');
        if (isBtn) {
          // 点击的是(取消或者确定)按钮
          var isConfirmBtn = isBtn === 'confirm';
          var isCancelBtn = isBtn === 'cancel';
          if (isCancelBtn) {
            tribute.hideMenu();
          }
          if (isConfirmBtn) {
            var _tribute$menu$querySe;
            var suggestDomList = ((_tribute$menu$querySe = tribute.menu.querySelector('ul')) === null || _tribute$menu$querySe === void 0 ? void 0 : _tribute$menu$querySe.children) || [];
            if (suggestDomList.length === 0) {
              return;
            }
            var checkedIndexs = [];
            // htmlCollection使用foreach方法
            [].forEach.call(suggestDomList, function (item) {
        ...
        if (tribute.menu && tribute.menu.contains(event.target)) {
          ...
          if (tribute.multipleSelectMode) {
            // 多选不关闭菜单
            var checked = li.getAttribute('data-tribute-selected') === '1';
  ...
  var Tribute = /*#__PURE__*/function () {
    function Tribute(_ref) {
      ...
      var _ref$values = _ref.values,
        ...
        _ref$multipleSelectMo = _ref.multipleSelectMode,
        multipleSelectMode = _ref$multipleSelectMo === void 0 ? false : _ref$multipleSelectMo;
    ...
    return _createClass(Tribute, [{
      ...
      value: function createMenu(containerClass) {
        ...
        var btnWrapper = this.range.getDocument().createElement("div");
      ...
      key: "selectItemsAtIndexList",
      value: function selectItemsAtIndexList(indexList, originalEvent) {
        var _this3 = this;
        var totalContent = '';
        indexList.forEach(function (index) {
          index = parseInt(index);
          var item = _this3.current.filteredItems[index];
          var content = _this3.current.collection.selectTemplate(item);
